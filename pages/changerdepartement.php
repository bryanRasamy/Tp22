...
<div class="row">
    ...
    <section class="col-6 col-sm-6 col-6 border shadow modif reglage">
        ...
        <h4 class="mt-4">Date de debut: <?php echo $fiche_employer['hire_date'];?></h4>
        <form action="traitementchangerdepartement.php" method="get" class="mt-5">
            ...
            <article>
                ...
                <div class="input-group mb-3">
                    <div class="form-floating">
                        <input type="Date" class="form-control" name="date" id="floatingInputGroup1" placeholder="Entrer la date de debut" value="<?php echo $fiche_employer['hire_date'];?>" required min="<?php echo $fiche_employer['hire_date'];?>">
