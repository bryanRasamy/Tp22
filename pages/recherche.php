    ...
    <section class="col-6 col-sm-6 col-6 border shadow modif reglage">
        ...
        <form action="traitementrecherche.php" method="get" class="mt-4">
            <article>
                ...
                <div class="input-group mb-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="departement" id="floatingInputGroup1" placeholder="Entrer le nom du departement">
            ...
            <article>
                ...
                <div class="input-group mb-3">
                    <div class="form-floating">
                        <input type="number" class="form-control" name="max" id="floatingInputGroup1" placeholder="Entrer l'age max" min="15" max="80">
